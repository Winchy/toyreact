...
export class Component {
  ...
  // get vchildren() {
  //   return this.children.map(child => child && child.vdom || null);
  // }
  [RENDER_TO_DOM](range) {
    this._range = range;
  ...
  update() {
    ...
    let update = (oldNode, newNode) => {
      ...
      // children
      // vdom一定会由vchildren，因为Component中vdom的get方法会递归调用，直到返回ElementWrapper
...
class ElementWrapper extends Component{
  ...
  get vdom() {
    this.vchildren = this.children.map(child => child && child.vdom || null);
    return this;
  }
  [RENDER_TO_DOM](range) {
    this._range = range;
